...
cost_data = {
    ...
    "ResultsByTime": [
        {
            "TimePeriod": {"Start": "2019-04-01", "End": "2019-05-01"},
            "Total": {},
            "Groups": [
                {
                    "Keys": ["AWS Budgets", "BudgetsUsage"],
                    "Metrics": {"BlendedCost": {"Amount": "1", "Unit": "USD"}},
                },
                {
                    "Keys": ["AWS Key Management Service", "us-east-1-KMS-Requests"],
...
class UnitTests(unittest.TestCase):
    ...
    def test_update_dictionary_item_list__given_starting_list__then_one_item_added(
        self,
    ):
        # Arrange
    ...
    def test_group_data_by_top_and_others__given_data_with_groups__then_correct_groupings_returned(
        self,
    ):
        # Arrange
        dataframe = pd.DataFrame(grouping_sample)
